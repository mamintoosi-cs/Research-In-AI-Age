...
| **جداکننده‌ها (Delimiters)** | برای مشخص‌کردن متن هدف از جداکنندهٔ سه‌گانه استفاده کنید: <br>```"""متن شما اینجا"""``` |
| **Few-shot (نمونه‌های آموزشی)** | چند مثال مطلوب نشان بدهید  تا قالب موردنظر را یاد بگیرد. (۲–۳ مثال کافی است) |
| **توسعهٔ تکراری (Iterate)** | پرامپت را اجرا کن ← خروجی را آنالیز کن ← پرامپت را اصلاح کن ← مجدداً اجرا کن. |
...
یک مجله مناسب برای ارسال این مقاله پیشنهاد بده و یک 
Cover Letter
