...
مشکل اصلی با ابزارهای هوش مصنوعی:
...
| **Context (زمینه)** | ارائه اطلاعات پیش‌زمینه | «در حال نوشتن بخش Related Work درباره CNN هستم.» |
...
<style>
table { width: 95%; margin: 0 auto; border-spacing: 12px; }
th, td { text-align: right; font-size: 0.9rem; vertical-align: top; }
code { direction: ltr; }
</style>

| چالش | مشکل کوتاه | راه‌حل سریع |
|------|------------:|-------------|
| **وابستگی بیش‌ازحد** | کاهش تفکر انتقادی؛‌ افت مهارت‌های پایه؛ درک سطحی موضوع. (نمونه: استفاده مداوم از ChatGPT). [پیوست نمونه](https://www.linkedin.com/posts/javascript-developer_ugcPost-7384140167781203968-wacI) | AI را به‌عنوان *ابزار کمکی* نگه دارید؛ مفاهیم را خودتان یاد بگیرید؛ خروجی‌ها را نقد و تفسیر کنید؛ از تمرین دستی و پروژه‌های مستقل استفاده کنید. |
